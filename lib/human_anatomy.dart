...
class HumanAnatomy extends StatefulWidget {
  ...
  @override
  _HumanAnatomyState createState() => _HumanAnatomyState();
}
...
class _HumanAnatomyState extends State<HumanAnatomy> {
      ...
      child: SizedBox(
        child: Stack(
          children: <Widget>[
            ...
            bodyPart("assets/left_soulder.svg", "leftSoulder", 90.0, 105.0, 0.0, 50.0),
            bodyPart("assets/right_soulder.svg", "rightSoulder", 89.0, 0.0, 110.0, 50.0),
            bodyPart("assets/left_arm.svg", "leftArm", 120.0, 145.0, 0.0, 70.0),
            bodyPart("assets/right_arm.svg", "rightArm", 118.0, 0.0, 142.0, 70.0),
            bodyPart("assets/left_elbow.svg", "leftElbow", 172.0, 172.0, 0.0, 39.0),
            bodyPart("assets/right_elbow.svg", "rightElbow", 170.0, 0.0, 170.0, 40.0),
            bodyPart("assets/left_forearm.svg", "leftForearm", 195.0, 190.0, 0.0, 54.0),
            bodyPart("assets/right_forearm.svg", "rightForearm", 195.0, 0.0, 190.0, 54.0),
            bodyPart("assets/left_wrist.svg", "leftWrist", 238.0, 220.0, 0.0, 23.0),
            bodyPart("assets/right_wrist.svg", "rightWrist", 238.0, 0.0, 220.0, 23.0),
            bodyPart("assets/left_hand.svg", "leftHand", 250.0, 250.0, 0.0, 60.0),
            bodyPart("assets/right_hand.svg", "rightHand", 250.0, 0.0, 250.0, 60.0),
            bodyPart("assets/left_thigh.svg", "leftThigh", 242.0, 63.0, 0.0, 138.0),
            bodyPart("assets/right_thigh.svg", "rightThigh", 242.0, 0.0, 63.0, 138.0),
            ...
            bodyPart("assets/left_ankle.svg", "leftAnkle", 495.0, 64.0, 0.0, 25.0),
            bodyPart("assets/right_ankle.svg", "rightAnkle", 493.0, 0.0, 68.0, 25.0),
            bodyPart("assets/left_foot.svg", "leftFoot", 510.0, 80.0, 0.0, 60.0),
            bodyPart("assets/right_foot.svg", "rightFoot", 508.0, 0.0, 83.0, 56.0),
          ],
        ),
      ),
    );
  ...
  Widget bodyPart(String svgPath, String svgName, double marginTop,
    ...
    final Widget bodyPartSvg = SvgPicture.asset(svgPath,
  ...
  void _publishSelection(List<String> _bodyPartList) {
    widget.onChanged?.call(_bodyPartList);
  }
}
